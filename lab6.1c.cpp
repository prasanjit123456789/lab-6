...
void askUserCalDatDisBill(float &unitCst,int &units,float &taxRt,float &salesTx,float &totDue){
	...
	//display the values
	cout<<"The unit cost is RS."<<unitCst<<endl<<"No. of units is "<<units<<endl
	<<"The tax rate is "<<taxRt<<"%"<<endl<<"Sales tax is RS."<<salesTx<<endl<<
	"The total due is RS."<<totDue<<endl<<"THANK YOU & VISIT AGAIN !";
}
//mainfunction
int main(){
